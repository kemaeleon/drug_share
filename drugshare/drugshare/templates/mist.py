...
#virus_index['areaName'] = virus_index.index
print(virus_index)
''' Merge with Population data '''
covid_uk = virus_index.merge(pop, how='inner', left_on='areaName', right_on='AREA')
...
barplots = barplots.drop(columns=['2020'])
